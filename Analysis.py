...
def level2():
    ...
    TEMP = 'C:/Users/admin/PycharmProjects/student/static/icon.png'
    SCALE = 10
    ...
    diff.save("C:/Users/admin/PycharmProjects/student/static/img.jpg")
    lab['text'] = lab['text'] + "\nDoing Histogram Analysis ..."
    window.update_idletasks()
    rec = cv2.face.LBPHFaceRecognizer_create()
    rec.read("TrainedDataFolder/TraningData.yml")
    imggray = PIL.Image.open("C:/Users/admin/PycharmProjects/student/static/img.jpg").convert('L')
